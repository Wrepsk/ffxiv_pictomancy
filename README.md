...
* AutoDraw also supports an experimental SceneComposite option that composites into the game backbuffer from a D3D11 hook before native UI/nameplates when the frame timing allows it.
